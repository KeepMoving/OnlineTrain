    ...
    <td width="602" valign="top" bgcolor="#FFFFFF"><table width="99%" height="487"  border="0" cellpadding="0" cellspacing="0" align="right">
      <tr>
        <td height="30" bgcolor="#EEEEEE" class="tableBorder_thin"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td width="40%" class="word_grey">&nbsp;当前位置：<span class="word_darkGrey">培训试题管理  &gt;&gt;&gt;</span></td>
...
<table width="96%"  border="0" cellspacing="0" cellpadding="0" height="24">
  <tr> 
    ...
    <td width="13%" valign="bottom"><html:link page="/manage/courses_Add.jsp">添加培训课程</html:link></td>
...
<table width="99%"  border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolordark="#FFFFFF" bordercolorlight="#67A8DB">
  <tr align="center" bgcolor="#A8D8FC">
	...
	<td width="36%" bgcolor="#B2D6F1" height="30">课程标题</td>
	<td width="10%" bgcolor="#B2D6F1">授课老师</td>
  ...
  <tr>
	...
	<td align="center"><html:link page="/manage/courses.do?action=coursesUp" paramId="upid" paramName="course" paramProperty="id">修改</html:link></td> 
    <td align="center"><html:link onclick="return check();"page="/manage/courses.do?action=coursesDel" paramId="upid" paramName="course" paramProperty="id">删除</html:link></td>
  </tr>
  </logic:iterate> 
</table>
<table width="94%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<html:link page="/manage/courses.do?action=coursesQuery&srow=0">首页</html:link>&nbsp;<%
		if((srow-10)>=0){
		  newValues.put("srow",srow-10);
		  pageContext.setAttribute("newValues",newValues);
  %><html:link page="/manage/courses.do?action=coursesQuery" name="newValues">上一页</html:link>&nbsp;
	 <%}else{ %>上一页&nbsp;<%}
	   if((srow+10)<=allrow){
	   newValues.put("srow",srow+10);
		  pageContext.setAttribute("newValues",newValues); 
	  %><html:link page="/manage/courses.do?action=coursesQuery" name="newValues">下一页</html:link>&nbsp;
	 <%}else{%>下一页&nbsp;<%} newValues.put("srow",(allrow/10)*10);pageContext.setAttribute("newValues",newValues); 
	 %><html:link page="/manage/courses.do?action=coursesQuery" name="newValues">尾页</html:link>&nbsp;
	</td>	
	  </tr>
