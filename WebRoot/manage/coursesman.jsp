...
<table width="778" border="0" align="center" cellspacing="0" cellpadding="0">
    ...
    <td width="602" valign="top" bgcolor="#FFFFFF"><table width="99%" height="487"  border="0" cellpadding="0" cellspacing="0" align="right">
      <tr>
        <td height="24" bgcolor="#EEEEEE" class="tableBorder_thin"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td width="40%" class="word_grey">&nbsp;当前位置：<span class="word_darkGrey">培训课程管理  &gt;&gt;修改</span></td>
  ...
  <tr>
      ...
      <table width="100%"  border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolordark="#FFFFFF" bordercolorlight="#67A8DB">		 
		 <tr>
			 <td colspan="5" height="30">培训课程内容文件列表&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="../Images/add.gif" width="19" height="18">添加文件
							<input type="FILE" id="file1" Name="file1" size="30"/>&nbsp;&nbsp;<input type="button" value="上传" onclick="modi()"/>
							<button onclick="window.location.href='/OnlineTrain/manage/courses.do?action=tasksMan&srow=0&upid=<%=ctemp.getId() %>'">查看作业</button>
			 </td>
		 </tr>
		 <tr> 
		  ...
		  <tr>		  	
			...
			<td align="center"> <a onclick="return checkForm();" href="deletefile.jsp?url=<%=cdf.getUrl() %>&upid=<%=cdf.getId() %>">删除 </a></td>			
		  </tr><%
		  	i++;
		 }
	...
	<html:link page="/manage/courses.do?action=coursesMan&srow=0">首页</html:link>&nbsp;<%
		if((srow-10)>=0){		 
		  newValues.put("srow",srow-10);  		  
		  pageContext.setAttribute("newValues",newValues);   
  %><html:link page="/manage/courses.do?action=coursesMan" name="newValues">上一页</html:link>&nbsp;
	 <%}else{ %>上一页&nbsp;<%}
	   if((srow+10)<=allrow){
	   	  newValues.put("srow",srow+10);  		  
		  pageContext.setAttribute("newValues",newValues); 
	  %><html:link page="/manage/courses.do?action=coursesMan" name="newValues">下一页</html:link>&nbsp;
	 <%}else{%>下一页&nbsp;<%} newValues.put("srow",(allrow/10)*10);pageContext.setAttribute("newValues",newValues); 
	 %><html:link page="/manage/courses.do?action=coursesMan" name="newValues">尾页</html:link>&nbsp;	 
	</td>
	</tr>	 
	</table>
	</form>
