    ...
    <td width="602" valign="top" bgcolor="#FFFFFF"><table width="99%" height="487"  border="0" cellpadding="0" cellspacing="0" align="right">
      <tr>
        <td height="30" bgcolor="#EEEEEE" class="tableBorder_thin"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
               <td width="40%" class="word_grey">&nbsp;当前位置：<span class="word_darkGrey">课程资料管理>>>资料修改</span></td>
...
<html:form action="/manage/data.do?action=dataModify" method="post" onsubmit="return checkForm(dataForm)"> 
  <bean:define id="defaultOption" name="dataModifyQuery" property="name" type="String"/>
  ...
  <tr align="center">
    ...
    <td width="80%" align="left"><html:text property="name" size="60" name="dataModifyQuery"/>
	  <html:hidden property="ID" name="dataModifyQuery"/>
	   * </td>
    </tr>
    
    <tr align="center">
    <td width="20%" height="30" align="right" style="padding:5px;">具体资料链接：</td>
    <td width="80%" align="left"><html:text property="link" size="60" name="dataModifyQuery"/>* </td>
    </tr>   	
    <tr>
