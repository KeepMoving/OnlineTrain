...
<table width="99%"  border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolordark="#FFFFFF" bordercolorlight="#67A8DB">
  <tr align="center" bgcolor="#A8D8FC">
	...
	<td width="13%" bgcolor="#B2D6F1">试卷管理</td>
  ...
  <tr>
	...
	<td align="center"><html:link page="/manage/paperm.do?action=paperQuery&srow=0" paramId="upid" paramName="course" paramProperty="id">查看</html:link></td>
  </tr>
  </logic:iterate> 
</table>
