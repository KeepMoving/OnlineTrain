...
<table width="778" border="0" align="center" cellspacing="0" cellpadding="0">
    ...
    <td width="602" valign="top" bgcolor="#FFFFFF"><table width="99%" height="487"  border="0" cellpadding="0" cellspacing="0" align="right">
      <tr>
        <td height="30" bgcolor="#EEEEEE" class="tableBorder_thin"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
               <td width="40%" class="word_grey">&nbsp;当前位置：<span class="word_darkGrey">课程试卷管理>>试卷添加>></span></td>
 ...
 <table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="90%">&nbsp;</td><%CourseForm ctemp = (CourseForm)session.getAttribute("course"); %>
</tr>
</table> 
<html:form action="/manage/paperm.do?action=pAddone" method="post" onsubmit="return checkForm(paperForm)">
