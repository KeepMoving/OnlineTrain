...
<table width="96%"  border="0" cellspacing="0" cellpadding="0">
  <tr> 
    ...
    <td width="53%" valign="bottom">为试卷添加多选题 </td>
  </tr>
</table>
<html:form action="/manage/paperm.do?action=pAddthree" method="post">
<table width="96%"  border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolordark="#FFFFFF" bordercolorlight="#67A8DB">
  ...
  <tr>  	
    ...
    <td align="center"><input type="checkbox" name="mores" border="no" value="<%=temps.getID() %>"/></td>
  </tr>
 <%
   }
 }
  %>    
	...
	<html:submit property="submit" styleClass="btn_grey" onclick="checkdel(questionsForm.delIdArray,questionsForm)" value="保存"/>
        &nbsp;
