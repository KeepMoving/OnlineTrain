...
<table width="778" border="0" align="center" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="602" valign="top" bgcolor="#FFFFFF"><table width="99%" height="487"  border="0" cellpadding="0" cellspacing="0" align="right">
      ...
      <tr>
		...
		<html:form action="/manage/paResultIf.do?action=paResultQuery" method="post">
          <tr>
  ...
  <%   
	...
	<html:link page="/manage/paResultIf.do?action=paResultQuery&srow=0">首页</html:link>&nbsp;<%
		if((srow-10)>=0){		 
		  newValues.put("srow",srow-10);  		  
		  pageContext.setAttribute("newValues",newValues);   
  %><html:link page="/manage/paResultIf.do?action=paResultQuery" name="newValues">上一页</html:link>&nbsp;
	 <%}else{ %>上一页&nbsp;<%}
	   if((srow+10)<=allrow){
	   newValues.put("srow",srow+10);  		  
		  pageContext.setAttribute("newValues",newValues); 
	  %><html:link page="/manage/paResultIf.do?action=paResultQuery" name="newValues">下一页</html:link>&nbsp;
