    ...
    <td width="602" valign="top" bgcolor="#FFFFFF"><table width="99%" height="487"  border="0" cellpadding="0" cellspacing="0" align="right">
      <tr>
        <td height="30" bgcolor="#EEEEEE" class="tableBorder_thin"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td width="40%" class="word_grey">&nbsp;当前位置：<span class="word_darkGrey">培训课程学习  &gt;&gt;&gt;</span></td>
...
<table width="99%"  border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolordark="#FFFFFF" bordercolorlight="#67A8DB">
  <tr align="center" bgcolor="#A8D8FC">
	...
	<td width="43%" bgcolor="#B2D6F1" height="30">课程标题</td>
  ...
  <tr>
    ...
    <td align="center"><html:link page="/student/course.do?action=coursesMan" paramId="upid" paramName="course" paramProperty="id">
    				   <bean:write name="course" property="course" filter="true"/></html:link></td>
...
<table width="94%"  border="0" cellspacing="0" cellpadding="0">
  ...
  <%   String tsrow =(String)request.getAttribute("srow").toString();
	...
	<html:link page="/student/course.do?action=courQuery&srow=0">首页</html:link>&nbsp;<%
		if((srow-10)>=0){
		  newValues.put("srow",srow-10);
		  pageContext.setAttribute("newValues",newValues);
  %><html:link page="/student/course.do?action=courQuery" name="newValues">上一页</html:link>&nbsp;
	 <%}else{ %>上一页&nbsp;<%}
	   if((srow+10)<=allrow){
	   newValues.put("srow",srow+10);
		  pageContext.setAttribute("newValues",newValues); 
	  %><html:link page="/student/course.do?action=courQuery" name="newValues">下一页</html:link>&nbsp;
	 <%}else{%>下一页&nbsp;<%} newValues.put("srow",(allrow/10)*10);pageContext.setAttribute("newValues",newValues); 
	 %><html:link page="/student/course.do?action=courQuery" name="newValues">尾页</html:link>&nbsp;
	</td>	
	  </tr>
 	</table>
      </tr>
