    ...
    <td width="602" valign="top" bgcolor="#FFFFFF"><table width="99%" height="487"  border="0" cellpadding="0" cellspacing="0" align="right">
      <tr>
        <td height="30" bgcolor="#EEEEEE" class="tableBorder_thin"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td width="40%" class="word_grey">&nbsp;当前位置：<span class="word_darkGrey">课程试卷管理  &gt;&gt;选择课程&gt;&gt;</span></td>
...
<table width="99%"  border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolordark="#FFFFFF" bordercolorlight="#67A8DB">
  <tr align="center" bgcolor="#A8D8FC">
	...
	<td width="13%" bgcolor="#B2D6F1">试卷阅览</td>
  ...
  <tr>
	...
	<td align="center"><html:link page="/student/papers.do?action=papersQuery&srow=0" paramId="upid" paramName="course" paramProperty="id">查看</html:link></td>
  </tr>
  </logic:iterate> 
</table>
<table width="94%"  border="0" cellspacing="0" cellpadding="0">
  ...
  <%   String tsrow =(String)request.getAttribute("srow").toString();
	...
	<html:link page="/manage/paperm.do?action=csQuery&srow=0">首页</html:link>&nbsp;<%
		if((srow-10)>=0){
		  newValues.put("srow",srow-10);
		  pageContext.setAttribute("newValues",newValues);
  %><html:link page="/manage/paperm.do?action=csQuery" name="newValues">上一页</html:link>&nbsp;
	 <%}else{ %>上一页&nbsp;<%}
	   if((srow+10)<=allrow){
	   newValues.put("srow",srow+10);
		  pageContext.setAttribute("newValues",newValues); 
	  %><html:link page="/manage/paperm.do?action=csQuery" name="newValues">下一页</html:link>&nbsp;
	 <%}else{%>下一页&nbsp;<%} newValues.put("srow",(allrow/10)*10);pageContext.setAttribute("newValues",newValues); 
	 %><html:link page="/manage/paperm.do?action=csQuery" name="newValues">尾页</html:link>&nbsp;
	</td>	
	  </tr>
