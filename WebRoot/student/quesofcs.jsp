    ...
    <td width="602" valign="top" bgcolor="#FFFFFF"><table width="99%" height="487"  border="0" cellpadding="0" cellspacing="0" align="right">
      <tr>
        <td height="30" bgcolor="#EEEEEE" class="tableBorder_thin"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td width="40%" class="word_grey">&nbsp;当前位置：<span class="word_darkGrey">课程试题练习 &gt;&gt;选择课程&gt;&gt;</span></td>
...
<table width="99%"  border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolordark="#FFFFFF" bordercolorlight="#67A8DB">
  <tr align="center" bgcolor="#A8D8FC">
	...
	<td width="11%" bgcolor="#B2D6F1">开课时间</td>
	<td width="11%" bgcolor="#B2D6F1">结课时间</td>	
	<td width="10%" bgcolor="#B2D6F1">单选题</td>
	<td width="10%" bgcolor="#B2D6F1">多选题</td>	
  </tr>
  ...
  <tr>
	...
	<td align="center"><html:link page="/manage/questions.do?action=selectList&srow=0&type=1" paramId="upid" paramName="course" paramProperty="id">练习</html:link></td>
  	<td align="center"><html:link page="/manage/questions.do?action=selectList&srow=0&type=2" paramId="upid" paramName="course" paramProperty="id">练习</html:link></td>
  </tr>
  </logic:iterate> 
</table>
